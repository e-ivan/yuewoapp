...
public class CaptchaUtil {
    ...
    private static String[] phonePrefix = {"134", "135", "136", "137", "138", "139", "147", "150", "151", "152", "157",
            "158", "159", "172", "178", "182", "183", "184", "187", "188", "198", "130", "131", "132", "145", "155", "156",
            "166", "171", "175", "176", "185", "186", "133", "149", "153", "173", "177", "180", "181", "189", "199"};
     ...
     * 随机生成打码的手机号码
     */
    public static String buildRandomCodingPhoneChar(){
        StringBuilder num = new StringBuilder(12);
        String pre = phonePrefix[ThreadLocalRandom.current().nextInt(phonePrefix.length)];
        return num.append(pre).append("****").append(genCaptcha(4)).toString();
    }
