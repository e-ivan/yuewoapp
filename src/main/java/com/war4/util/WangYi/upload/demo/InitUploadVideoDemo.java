    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (initUploadVideoParam.getCode() == 200) {
                System.out.println("[InitUploadVideoDemo] init upload params successfully. " + initUploadVideoParam.getRet().toString());
            } else {
                System.out.println("[InitUploadVideoDemo] fail to init upload params. " + "return code " + initUploadVideoParam.getCode() + " return message " + initUploadVideoParam.getMsg());
            }
