package com.war4.util.WangYi.upload.util;
...
import com.war4.util.WangYi.util.HttpClientBuilder;
import com.war4.util.WangYi.util.HttpGetBuilder;
import com.war4.util.WangYi.util.HttpPostBuilder;
	...
	*/
	public UploadVideoFragmentParam uploadVideoFragment() throws VcloudException, IOException{
		...
		if(remainderSize > 0){
			...
			//System.out.println("[UploadVideo] : 文件剩余大小： " + remainderSize);
			/* 判读是否是最后一片 */
