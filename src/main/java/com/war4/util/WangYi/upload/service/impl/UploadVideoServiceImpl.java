...
public class UploadVideoServiceImpl implements UploadVideoService {
	...
	* @throws IOException
	* @see com.war4.util.WangYi.upload.util.service.impl.UploadVideoService#uploadVideo(java.lang.String, java.util.Map)
	*/
			 ...
			 try {			 
				 ...
				 while(remainderSize > 0){
					 ...
					 if(null == uploadVideoParam.getErrMsg() || "".equals(uploadVideoParam.getErrMsg().trim())){
						...
						// System.out.println("[UploadDemo] errMsg:" + uploadVideoParam.getErrMsg());
					 }else{
